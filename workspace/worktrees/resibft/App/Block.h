...
private:
	...
	std::string transactions2string() const;
...
public:
	...
	bool isDummy() const; // True if the block is not set
	bool getSet() const;
	...
	bool extends(Hash hash) const; // Check whether this block extends from [Hash]
	Hash hash() const;
