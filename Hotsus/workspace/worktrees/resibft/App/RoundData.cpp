...
Hash RoundData::getProposeHash() const
{
	return this->proposeHash;
}

View RoundData::getProposeView() const
{
	return this->proposeView;
}

Hash RoundData::getJustifyHash() const
{
	return this->justifyHash;
}

View RoundData::getJustifyView() const
{
	return this->justifyView;
}

Phase RoundData::getPhase() const
{
	return this->phase;
}

void RoundData::setPhase(Phase phase)
{
	this->phase = phase;
}
...
std::string RoundData::toPrint() const
{
	std::string text = "";
	text += "ROUNDDATA[";
...
std::string RoundData::toString() const
{
	std::string text = "";
