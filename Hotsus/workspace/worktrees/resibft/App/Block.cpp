...
std::string Block::transactions2string() const
{
	std::string text = "";
...
bool Block::isDummy() const
{
	return !this->set;
}

bool Block::getSet() const
{
	return this->set;
}
...
bool Block::extends(Hash hash) const
{
...
std::string Block::toPrint() const
{
