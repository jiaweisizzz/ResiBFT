...
bool Justification::isSet() const
{
	return this->set;
}

RoundData Justification::getRoundData() const
{
	return this->roundData;
}

Signs Justification::getSigns() const
{
	return this->signs;
}

bool Justification::wellFormedInitialize() const
{
...
bool Justification::wellFormedNewview() const
{
...
bool Justification::wellFormedPrepare(unsigned int quorumSize) const
{
...
bool Justification::wellFormed(unsigned int quorumSize) const
{
...
View Justification::getCertificationView() const
{
...
Hash Justification::getCertificationHash() const
{
	if (wellFormedInitialize() || wellFormedNewview())
	{
...
std::string Justification::toPrint() const
{
	std::string text = "";
	text += "JUSTIFICATION[";
