...
bool Signs::hasSigned(ReplicaID replicaId) const
{
...
std::set<ReplicaID> Signs::getSigners() const
{
...
std::string Signs::printSigners() const
{
	std::string text = "-";
	for (int i = 0; i < this->size; i++)
	{
...
std::string Signs::toPrint() const
{
